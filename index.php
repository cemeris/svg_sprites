...
<svg width="152" viewBox="0 0 152 124" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M150 95.5C138 128 92.5 147.5 3.50002 57.5C0.666688 57.5 -1.49998 50.1 12.5 20.5C26.5 -9.10003 76 1.16664 99 9.99997C120 27.6666 159.6 69.5 150 95.5Z" stroke="black"/>
</svg>
...
<svg class="icon accent" viewBox="0 0 22 19">
    <use xlink:href="#svg_message"></use>
</svg>
<svg class="icon" viewBox="0 0 22 22">
    <use xlink:href="#svg_explore"></use>
</svg>

<svg class="icon accent" viewBox="0 0 22 22">
  <use xlink:href="#svg_home"></use>
</svg>
